        ...
        <Box>
          <Text display="inline" color="currentColor">
            ...
            <p>
              ...
              <br />
              <br />
              {t("Claim your Farm rewards on 9mm Swap and your Merkl rewards on")}
            ...
            <br />
            <br />
            {t("To earn Farm rewards, continue seeding liquidity on 9mm Swap and stake your LP token in the Farm.")}
          </Text>
        </Box>
      </>
    );
