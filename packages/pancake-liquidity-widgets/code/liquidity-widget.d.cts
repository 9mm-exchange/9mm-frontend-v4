...
declare function Widget({ theme: themeProps, walletClient, account, chainId, networkChainId, initTickLower, initTickUpper, poolAddress, positionId, feeAddress, feePcm, includedSources, excludedSources, source, initDepositTokens, initAmounts, onDismiss, onTxSubmit, onConnectWallet, onAddTokens, onRemoveToken, onAmountChange, onOpenTokenSelectModal, farmContractAddresses, }: WidgetProps): react_jsx_runtime.JSX.Element;
