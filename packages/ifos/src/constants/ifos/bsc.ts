...
export const ifos: BaseIfoConfig[] = [
  ...
  },
  {
    ...
    description:
      'Cakepie is a veCAKE Manager that boosts rewards for CAKE stakers and PancakeSwap’s liquidity providers, as part of the wider [veCAKE Ecosystem](https://9mm-pro.gitbook.io/9mm-pro/products/vecake/vecake-managers)',
    vestingTitle:
