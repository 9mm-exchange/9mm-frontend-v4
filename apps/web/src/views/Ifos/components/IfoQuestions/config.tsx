...
const config = [
    ...
    description: [
      ...
      <Box mt="1rem">
        ...
        <InlineLink
          ml="4px"
          external
          href="https://9mm-pro.gitbook.io/9mm-pro/products/ifo-initial-farm-offering/icake"
        >
          <Trans>here</Trans>
        </InlineLink>
      </Box>,
  ...
  },
  {
    ...
    description: [
      ...
      <Box mt="1rem">
        <Trans>
          Just remember: you need an active 9mm Swap Profile in order to participate in Private and Public Sales.
        </Trans>
      </Box>,
    ],
  },
