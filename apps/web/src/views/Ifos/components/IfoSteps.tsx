    ...
    <CardBody>
      ...
      <Box>
        ...
        <Link
          ...
          color="textSubtle"
          small
          href="https://9mm-pro.gitbook.io/9mm-pro/products/ifo-initial-farm-offering/icake#how-is-icake-calculated"
        >
        ...
        return (
          <CardBody>
            ...
            <Text color="textSubtle" small mb="16px">
              {isCrossChainIfo
                ? t('You’ll need an active 9mm Swap Profile to take part in the IFO’s Public Sale!')
