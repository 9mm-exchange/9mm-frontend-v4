...
const MAJOR_DEFINED_STABLE_COINS: {
  ...
  [ChainId.PULSECHAIN]: [USDC[ChainId.PULSECHAIN], DAI[ChainId.PULSECHAIN], USDT[ChainId.PULSECHAIN]],
  [ChainId.SONIC]: [USDC[ChainId.SONIC], USDT[ChainId.SONIC]],
  [ChainId.OPTIPULSE]: [USDC[ChainId.OPTIPULSE], USDT[ChainId.OPTIPULSE], DAI[ChainId.OPTIPULSE]],
