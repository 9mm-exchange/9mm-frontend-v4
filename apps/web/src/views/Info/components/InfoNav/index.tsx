...
import { arbitrum, base, bsc, linea, mainnet, opBNB, polygonZkEvm, pulsechain, zkSync } from 'wagmi/chains'
...
const targetChains = [mainnet, pulsechain, bsc, polygonZkEvm, zkSync, arbitrum, linea, base, opBNB]
