  ...
  return (
    <Container>
      ...
      <Text as="p">
        ...
        general matter, the 9mm Swap team is not a liquidity provider into Protocol liquidity pools and liquidity
        providers are independent third parties. The Protocol was initially deployed on the PulseChain blockchain, and
      ...
      <Text as="p">
        ...
        such as rarity scores, token explorer or token lists (which includes the 9mm Swap default token list and 9mm
      ...
      <Text as="p">
        ...
        representation or warranty about the safety or soundness of any cross-chain bridge, including its use for 9mm
        Swap governance.
      </Text>
      <Text as="p">
