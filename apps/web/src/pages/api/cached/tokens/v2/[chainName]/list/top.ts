...
/**
 * API Handler for Top Tokens V2
 *
 * Endpoint: /api/cached/tokens/v2/[chainName]/list/top
 *
 ...
 *
 * Cache key format: tokens/v2/{chainName}/list/top -> tokens-v2-{chainName}-list-top
 */
const handler: NextApiHandler = async (req, res) => {
  try {
    ...
    const apiPath = `tokens/v2/${chainName}/list/top`
