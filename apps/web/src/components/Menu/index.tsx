...
const Menu = (props) => {
  ...
  const [onPerpConfirmModalPresent] = useModal(
    <USCitizenConfirmModal title={t('9mm Swap Perpetuals')} id={IdType.PERPETUALS} href={perpUrl} />,
    true,
    false,
    'perpConfirmModal',
  )
  ...
  return (
    <UikitMenu
      ...
      buyCakeLink="/swap?outputCurrency=0x7b39712Ef45F7dcED2bBDF11F3D5046bA61dA719&chainId=369"
      {...props}
    />
  )
}
