...
export const useActiveChainId = () => {
  ...
  const chainId = localChainId ?? wagmiChainId ?? (queryChainId >= 0 ? ChainId.PULSECHAIN : undefined)
  ...
  return {
    chainId: chainId && isChainSupported(chainId) ? chainId : ChainId.PULSECHAIN,
    isWrongNetwork,
    isNotMatched,
  }
}
