...
// 20 WTPLS per block is sent to Burn pool (A farm just for burning cake)
// 10 WTPLS per block goes to CAKE syrup pool
// 9 WTPLS per block goes to Yield farms and lottery
