...
export const SUGGESTED_BASES: ChainTokenList = {
  ...
  [ChainId.OPTIPULSE]: [optiTokens.dai, optiTokens.usdc, optiTokens.usdt, pulseTokens.ninemm],
...
export const BASES_TO_TRACK_LIQUIDITY_FOR: ChainTokenList = {
  ...
  [ChainId.OPTIPULSE]: [optiTokens.dai, optiTokens.usdc, optiTokens.usdt, WNATIVE[ChainId.OPTIPULSE]],
  [ChainId.GOERLI]: [USDC[ChainId.GOERLI], WNATIVE[ChainId.GOERLI], BUSD[ChainId.GOERLI]],
...
export const PINNED_PAIRS: { readonly [chainId in ChainId]?: [Token, Token][] } = {
  ...
  [ChainId.OPTIPULSE]: [[WNATIVE[ChainId.OPTIPULSE], optiTokens.nineMM]],
  [ChainId.BSC]: [
...
export const LIMIT_ORDERS_DOCS_URL = 'https://9mm-pro.gitbook.io/9mm-pro/products/pancakeswap-exchange/limit-orders'
