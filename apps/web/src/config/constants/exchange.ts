...
export const SUGGESTED_BASES: ChainTokenList = {
  ...
  [ChainId.PULPCHAIN]: [pulpTokens.dai, pulpTokens.usdc, pulpTokens.usdt, pulpTokens.nineMM],
...
export const BASES_TO_TRACK_LIQUIDITY_FOR: ChainTokenList = {
  ...
  [ChainId.PULPCHAIN]: [pulpTokens.dai, pulpTokens.usdc, pulpTokens.usdt, WNATIVE[ChainId.PULPCHAIN]],
  [ChainId.GOERLI]: [USDC[ChainId.GOERLI], WNATIVE[ChainId.GOERLI], BUSD[ChainId.GOERLI]],
...
export const PINNED_PAIRS: { readonly [chainId in ChainId]?: [Token, Token][] } = {
  ...
  [ChainId.PULPCHAIN]: [[WNATIVE[ChainId.PULPCHAIN], pulpTokens.nineMM]],
  [ChainId.BSC]: [
