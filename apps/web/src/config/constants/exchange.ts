...
export const SUGGESTED_BASES: ChainTokenList = {
  ...
  [ChainId.OPTIPULSE]: [pulpTokens.dai, pulpTokens.usdc, pulpTokens.usdt, pulpTokens.nineMM],
...
export const BASES_TO_TRACK_LIQUIDITY_FOR: ChainTokenList = {
  ...
  [ChainId.OPTIPULSE]: [pulpTokens.dai, pulpTokens.usdc, pulpTokens.usdt, WNATIVE[ChainId.OPTIPULSE]],
  [ChainId.GOERLI]: [USDC[ChainId.GOERLI], WNATIVE[ChainId.GOERLI], BUSD[ChainId.GOERLI]],
...
export const PINNED_PAIRS: { readonly [chainId in ChainId]?: [Token, Token][] } = {
  ...
  [ChainId.OPTIPULSE]: [[WNATIVE[ChainId.OPTIPULSE], pulpTokens.nineMM]],
  [ChainId.BSC]: [
